...
#define MACSLEP LSFT(LCTL(KC_POWER))  // Screen Lock/Sleep on macos - Ctrl-Shift-Power
 ...
 */
  ...
  /* FN1 Layer (Movement)
   * ,---------------------------------------------------------------------------------------.
   * | FN2 |  F1 |  F2 |  F3 |  F4 |  F5 |  F6 |  F7 |  F8 |  F9 | F10 | F11 | F12 |x| SLEEP |
   * |---------------------------------------------------------------------------------------+
   * |        |PgUp |  U  |PgDn |     |     |     |     | PgUp|     |     | Home| End |      |
   * |---------------------------------------------------------------------------------------+
   * |         |  L  |  D  |  R  |     |     |  L  |  D  |  U  |  R  |     |     |           |
   * |---------------------------------------------------------------------------------------+
   * |            |Home | End |     |     |     | PnDn|     |     |     |     |x|          |x|
  ...
  LAYOUT_directional(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS,          XXXXXXX,          KC_NO,            XXXXXXX, KC_TRNS,           KC_TRNS, XXXXXXX, KC_TRNS, KC_F16
      ),
  ...
  LAYOUT_directional(
      KC_TRNS,          RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_M_P, KC_NO,   KC_SLCK, KC_PAUS, XXXXXXX, KC_NO,
